...
def assert_get_exercise_response(
    ...
    """
    Проверяет, что ответ на запрос задания по его id соответствует ранее созданным данным

    :param get_exercise_response: Ответ на запрос задания по его id
    :param create_exercise_response: Ответ API с данными созданного задания
    :raises AssertionError: Если хотя бы одно поле не совпадает
    """
...
def assert_exercise_not_found_response(actual: InternalErrorResponseSchema):
    """
    Проверяет, что API возвращает корректную ошибку, если задание не найдено
